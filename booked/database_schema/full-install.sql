DROP DATABASE IF EXISTS reservadesalas;

CREATE DATABASE reservadesalas;

USE reservadesalas;
GRANT ALL on reservadesalas.* to 'reservadesalas'@'localhost' identified by 'mKRq2RT';
GRANT ALL on reservadesalas.* to 'reservadesalas'@'127.0.0.1' identified by 'mKRq2RT';SET foreign_key_checks = 0;
